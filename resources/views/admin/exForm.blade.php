...
<form action="{{ route('exercices.store') }}" method="POST" class="bg-white p-6 rounded-2xl shadow-md max-w-3xl mx-auto mt-10 space-y-4" enctype="multipart/form-data">
    ...
    <div>
        <label for="duration" class="block text-sm font-medium text-gray-700">Durée (en secondes)</label>
        <input type="number" name="duration" id="duration" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[#C447AF] focus:border-[#C447AF]" required>
    </div>
