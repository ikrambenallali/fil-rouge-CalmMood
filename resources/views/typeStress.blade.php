...
@section('content')
    ...
    <div class="flex-1 bg-[#FBF4FA]">
        <!-- Header section -->
        <div class="bg-white py-6 px-8 shadow-lg mb-8 rounded-lg">
            <div class="flex justify-between items-center">
                <h1 class="text-3xl font-bold text-[#C447AF]">Stress Types</h1>
                <div class="flex items-center space-x-4">
                    <!-- Add any header icons or elements if necessary -->
                </div>
            </div>
        </div>
